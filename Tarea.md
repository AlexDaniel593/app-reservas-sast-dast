# Implementación de Quality Gates con SonarQube y Notificaciones vía Telegram Tarea 2
...
- Asignar un nombre al bot (por ejemplo, `equipo_dev_notifier_bot`). name `Dev Bot`
